...
Description:
This is the streaming implementation to access Cell
...
import com.garinternal.common.excel.xlsx.exceptions.NotSupportedException;
...
public class StreamingCell implements Cell {
     ...
     * @param use1904Dates Use 1904 dates or not
     */
    ...
    public LocalDateTime getLocalDateTimeCellValue() {
        return LocalDateTime.ofInstant(Instant.ofEpochMilli(this.getDateCellValue().getTime()), ZoneId.systemDefault());
    }
