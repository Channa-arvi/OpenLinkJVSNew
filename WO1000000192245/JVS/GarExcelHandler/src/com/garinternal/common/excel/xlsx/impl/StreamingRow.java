...
Description:
This is the streaming implementation to access Row
...
public class StreamingRow implements Row {
    ...
    public Cell getCell(int cellnum, MissingCellPolicy policy) {
        ...
        } else if (policy == MissingCellPolicy.RETURN_BLANK_AS_NULL && (cell == null || cell.getCellType() == CellType.BLANK)) {
            return null;
        }
