...
Description:
 File-backed list-like class. Allows addition of arbitrary numbers of array entries (serialized to JSON) in a binary
 packed file. Reading of entries is done with an NIO channel that seeks to the entry in the file.
 <p>
 File entry format:
 <ul>
 ...
 <p>
 Pointers to the offset of each entry are kept in a {@code List<Long>}. The values loaded from the the file are cached up to a maximum of
...
public class FileBackedList implements AutoCloseable {
     ...
     * 
     * @param file           File
     * @param cacheSizeBytes cacheSizeBytes
