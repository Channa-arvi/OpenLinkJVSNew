...
/*
File Name:                      StreamingSheetReader.java
...
Description:
This is the streaming implementation to read Sheet
...
import com.garinternal.common.excel.xlsx.exceptions.CloseException;
...
public class StreamingSheetReader implements Iterable<Row> {
     ...
     * @param parser       XMLEventReader
     * @param use1904Dates use1904Dates
     * @param rowCacheSize rowCacheSize
     */
    public StreamingSheetReader(SharedStringsTable sst, StylesTable stylesTable, XMLEventReader parser, final boolean use1904Dates,
        int rowCacheSize) {
        this.sst          = sst;
    ...
    private void handleEvent(XMLEvent event) {
        ...
        if (event.getEventType() == XMLStreamConstants.CHARACTERS) {
        ...
        } else if (event.getEventType() == XMLStreamConstants.START_ELEMENT && this.isSpreadsheetTag(event.asStartElement().getName())) {
            ...
            if ("row".equals(tagLocalName)) {
                ...
                boolean   isHidden     =
                    isHiddenAttr != null && ("1".equals(isHiddenAttr.getValue()) || "true".equals(isHiddenAttr.getValue()));
                ...
                if (ref != null) {
                    ...
                    this.currentCell   =
                        new StreamingCell(this.sheet, this.currentColNum, Integer.parseInt(coord[1]) - 1, this.use1904Dates);
                } else {
            ...
            this.lastContents = "";
        } else if (event.getEventType() == XMLStreamConstants.END_ELEMENT && this.isSpreadsheetTag(event.asEndElement().getName())) {
                        ...
                        public Object getContent() {
                            ...
                            if (this.cachedContent == null) {
                                this.cachedContent = StreamingSheetReader.this.dataFormatter.formatRawCellContents(
                                    Double.parseDouble(currentLastContents), currentNumericFormatIndex, currentNumericFormat);
                            }
    ...
    class StreamingRowIterator implements Iterator<Row> {
        ...
        public boolean hasNext() {
            return (StreamingSheetReader.this.rowCacheIterator != null && StreamingSheetReader.this.rowCacheIterator.hasNext())
                || StreamingSheetReader.this.getRow();
        }
