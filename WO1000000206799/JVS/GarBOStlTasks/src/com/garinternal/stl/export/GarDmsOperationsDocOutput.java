...
/*
File Name:                      GarDmsOperationsDocOutput.java
...
Description:
Output script for Operations Documents
...
public class GarDmsOperationsDocOutput extends GarDmsBasicOutput {
     ...
     * @param logger
     */
    protected GarDmsOperationsDocOutput(GarLogger logger) {
        super(logger);
        this.logger = logger;
    }
    ...
    private String enhanceFolderName(String folderName, String folderPrefix) {
        return folderPrefix + "_OPS_" + folderName;
    }
}
