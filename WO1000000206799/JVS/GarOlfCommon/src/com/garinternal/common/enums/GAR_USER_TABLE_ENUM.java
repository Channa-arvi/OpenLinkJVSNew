...
public enum GAR_USER_TABLE_ENUM {
    ...
    USER_COUNTERPARTY_PAYMENT_TERM   ("USER_counterparty_payment_term"),
    USER_SAP_PURCHASING_DATA         ("USER_sap_purchasing_data"),
    USER_OPERATIONCOST_TEMPLATES     ("USER_operationcost_templates"),
    USER_STLDOC_EXPORT_CONFIG        ("USER_stldoc_export_config"),
	;
    //@formatter:on
